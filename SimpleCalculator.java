...
public class SimpleCalculator implements ActionListener {
    ...
    Font myFont = new Font("Segoe UI", Font.BOLD, 28);

    double num1 = 0, num2 = 0, result = 0;
    char operator;
    boolean isResultDisplayed = false; // track if result is on screen

    SimpleCalculator() {
        frame = new JFrame("GAURIKA MALVIYA RA2411003011462");
